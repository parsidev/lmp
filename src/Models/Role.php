...
namespace Parsidev\Permission\Models;

use Jenssegers\Mongodb\Eloquent\Model;
use Jenssegers\Mongodb\Relations\BelongsToMany;
use Parsidev\Permission\Contracts\RoleInterface;
use Parsidev\Permission\Exceptions\GuardDoesNotMatch;
use Parsidev\Permission\Exceptions\RoleAlreadyExists;
use Parsidev\Permission\Exceptions\RoleDoesNotExist;
use Parsidev\Permission\Guard;
use Parsidev\Permission\Helpers;
use Parsidev\Permission\Traits\HasPermissions;
use Parsidev\Permission\Traits\RefreshesPermissionCache;
use ReflectionException;

/**
 * Class Role
 * @package Parsidev\Permission\Models
 */
class Role extends Model implements RoleInterface
{
     ...
     * @throws \Parsidev\Permission\Exceptions\RoleAlreadyExists
     * @throws \ReflectionException
     */
